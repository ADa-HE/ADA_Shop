...
<div class="sidebar-wrapper" data-simplebar="true">
            ...
            <div class="page-wrapper">
                <div class="page-content">
                    ...
                    <h6 class="mb-0 text-uppercase">DataTable Employee</h6>
                    <hr/>
                    <div class="col-lg-3 col-xl-2">
                        <a href="ControllerEmployee?do=insertEmloyee" class="btn btn-light mb-3 mb-lg-0"><i class='bx bxs-plus-square'></i>New Employee</a>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <%
                                    Vector<Employees> vector = (Vector<Employees>) request.getAttribute("list");
                                ...
                                <table id="example" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="ControllerEmployee?do=updateEmployee&pid=<%= emp.getEmployeeID()%> ">udpate</a></td>
                                            <td><a href="ControllerEmployee?do=updateEmployee&pid=<%=emp.getEmployeeID()%>  ">delete</a></td>                 
                                        </tr>
                                        <%}%>
                                    </tbody>
