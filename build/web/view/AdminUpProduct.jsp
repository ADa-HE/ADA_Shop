    ...
    <body class="bg-theme bg-theme2">
        ...
        <div class="wrapper">
           ...
           <div class="sidebar-wrapper" data-simplebar="true">
            ...
            ResultSet rsSupplier = (ResultSet) request.getAttribute("rsSupplier");
            ResultSet rscategories = (ResultSet) request.getAttribute("rscategories");
        %>
        <%if(rsProDuct.next()){%>
        <form action="ControllerProduct" method="post">
            ...
            <table>
                <tr>
                    <td>ProducID</td>
                    <td><input type="text" value="<%= rsProDuct.getInt(1)%>" name="pid" readonly></td>
                </tr>
                <tr>
                    <td>ProductName</td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="suppId" id="suppId">
                            ...
                            <option value="<%= rsSupplier.getInt(1)%>" <%=(rsSupplier.getInt(1) == rsProDuct.getInt(3) ? " selected" : "")%>> <%=rsSupplier.getString(2)%> </option>
                            <%}%>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><select name="cateId" id="cateId">
                            ...
                            <option value="<%=rscategories.getInt(1)%>" <%=(rscategories.getInt(1) == rsProDuct.getInt(4) ? " selected" : "")%> > <%= rscategories.getString(2)%> </option>
                            <%}%>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <td>Discontinued</td>
                    <td><input type="radio" value="1" name="discontinute" <%= rsProDuct.getInt(10) == 1 ? " checked" : ""%> > continute
                        <input type="radio" value="0" name="discontinute" <%=(rsProDuct.getInt(10) == 0 ? " checked" : "")%> >discontinute </td>
                </tr>
                <tr>
                    <td>images</td>
                    <td> <input type="text" value="<%= rsProDuct.getString(11)%> " name="img"> </td>
                </tr>
                <tr>
