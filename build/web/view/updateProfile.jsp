...
<html lang="en">
    ...
    <body>
        ...
        <form class="row g-3" action="ControllerCustomer" method="post">
            <input value="pdateustomer" name="do" type="hidden">
            
            <div class="col-md-6">
                CompanyName:<input type="text" name="cpName" class="form-control" id="inputCity">
            </div>
            <div class="col-md-6">
                ContactName:<input type="text" name="ctName" class="form-control" id="inputCity">
            </div>
            <div class="col-md-6">
                contacTitle:<input type="text" name="contacTitle" class="form-control" id="inputCity">
            </div>
            <div class="col-md-6">
                Address:<input type="text" name="address" class="form-control" id="inputCity">
            </div>
            <div class="col-md-6">
                City:<input type="text" name="city" class="form-control" id="inputCity">
            </div>
            <div class="col-md-6">
                Region:<input type="text" name="region" class="form-control" id="inputCity">
            </div>
            <div class="col-md-6">
                pscode:<input type="text" name="pscode" class="form-control" id="inputCity">
            </div>
            <div class="col-md-6">
                country:<input type="text" name="country" class="form-control" id="inputCity">
            </div>
            <div class="col-md-6">
                Phone:<input type="text" name="phone" class="form-control" id="inputCity">
            </div>
            <div class="col-md-6">
                fax:<input type="text" name="fax" class="form-control" id="inputCity">
            </div>
